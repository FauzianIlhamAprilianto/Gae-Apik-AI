...
export const GaeApik = [
    { 
        id: 1, 
        title: "Bangun pagi ojo kesiangan", 
        description: "Sakwise turu ojo kesuwen, awakmu kudu tangi luwih awal ben badan iso luwih seger, pikiran yo luwih ora mumet.", 
        how: "Pasang alarm 30-45 menit luwih awal, taruh HP adoh sek ben kowe kudu tangi beneran ambil alarm.", 
        benefit: "Iso nyiapke urusan esuk luwih santai, ora grusa-grusu, lan pikiran dadi luwih tenang. Bangun awal nggawe awakmu luwih produktif lan ora keburu-buru sak harian. Wong sing tangi luwih awal biasane mood-nya luwih stabil." 
    },
    { 
        id: 2, 
        title: "Ngombe banyu putih 2 gelas", 
        description: "Sakwise turu semaleman, awakmu biasane kekurangan cairan, makane kudu minum banyu ben ora kemlithik lan tetap seger.", 
        how: "Siapke gelas banyu putih nang meja utawa samping kasur, ben pas tangi iso langsung ngombe tanpa males.", 
    ...
    { 
        id: 3, 
        title: "Jalan-jalan 10 menit", 
        description: "Mlaku-mlaku cendek nang njaba omah iso nggawe jantungmu gerak, nambah oksigen, lan pikiran dadi luwih fresh.", 
        how: "Cukup mlaku nang teras, gang depan, atau muter-muter nang halaman, sambil tarik napas jero.", 
        benefit: "Mood dadi luwih apik, awak ra loyo, lan semangat meningkat. Mlaku-mlaku cendhek iso nyegarke otak lan ngurangi stres. Kadang malah muncul ide-ide apik pas mlaku." 
    },
    { 
        id: 4, 
        ...
        how: "Duduk nang kursi utawa lesehan, tutup mripat, tarik napas alon-alon, rasakke sak lawase 3-5 menit wae cukup.", 
        benefit: "Stres iso mudhun, otak luwih fokus, lan ati luwih tenang. Pikiranmu dadi luwih jernih lan ora gampang kebawa emosi. Cocok kanggo persiapan ngadepi aktivitas sak dinane." 
    },
    { 
        id: 5, 
        title: "Nulis jurnal", 
    ...
    { 
        ...
        how: "Ucapke langsung, lewat chat, utawa WA, contone 'makasih yo', 'keren kamu', atau 'semangat terus rek'.", 
    ...
    { 
        ...
        description: "Wektu cilik iso dimanfaatke kanggo nambah ilmu utawa inspirasi sing iso nyadarke pikiranmu.", 
    ...
    { 
        ...
        description: "Ngendhog sak bentar karo secangkir teh utawa kopi iso nggawe awak lan pikiran lebih rileks.", 
        how: "Siapke teh utawa kopi favoritmu, duduk santai, hirup aromane sakdurunge diminum.", 
    ...
    { 
        ...
        how: "Tutupi mripat sak bentar, tarik napas alon, terus pikirke minimal siji utawa loro hal apik sing wis koe duweni.", 
    ...
    { 
        id: 12, 
        title: "Ngucap salam karo tetanggan", 
        description: "Tetanggan sing akrab iso nggawe suasana lingkungan luwih tentrem lan rukun.", 
        how: "Pas metu omah, sempetno mampir sebentar, senyum, sapa, utawa ngajak ngobrol ringan.", 
    ...
    { 
        ...
        description: "Ngisi otak sak pagi nganggo ilmu ringan ben pikiran ora mandek lan tetep aktif.", 
        how: "Ambil buku kesukaan, baca minimal 5-10 menit, ora usah akeh-akeh sing penting konsisten.", 
    ...
    { 
        ...
        how: "Tulis siji quotes sing nyemangati nang buku catetan, sticky note, atau HP ben iso dibaca kapan wae.", 
        benefit: "Iso nguatke mental lan nambah keberanian ngadepi hari. Quotes sing ditulis iso dadi pengingat nek kowe kuat lan iso. Kadang mung kalimat cilik, ning efeknya gede nang batin." 
    },
    { 
        id: 18, 
        ...
        benefit: "Ati luwih seneng, hubungan makin akrab, lan stres iso ilang pelan-pelan. Obrolan sederhana iso dadi obat pikiran. Kadang malah muncul ide-ide menarik saka obrolan ringan." 
    },
    { 
        id: 19, 
        ...
        how: "Lap layar nganggo kain alus, buang file ora penting, rapikan folder biar gampang dicari.", 
        benefit: "Pemakaian luwih nyaman, kerjaan luwih teratur, lan perangkat luwih awet. File rapi nggawe kamu ora bingung pas butuh. Rasane yo lega ndelok perangkat bersih kinclong." 
    },
    { 
        id: 20, 
        title: "Ngatur jadwal sederhana", 
        description: "Nulis rencana cilik iso mbantu ngatur kegiatan supaya ora kebuang waktune sak harian.", 
    ...
    { 
        ...
        how: "Siapke buah seger, yoghurt, utawa kacang-kacangan, taruh nang piring cantik ben ngganjel weteng.", 
    ...
    { 
        ...
        how: "Kirim pesan semangat, ucapan makasih, utawa doa apik nang WA, IG, atau chat kanca.", 
    ...
    { 
        ...
        description: "Musik iso dadi pelarian sing nyenengke lan iso ningkatno mood kapan wae butuh.", 
        how: "Tambah lagu-lagu favorit nang playlist HP, Spotify, YouTube, ben gampang diputarke kapan wae.", 
        benefit: "Sampean bakal duwe hiburan sing gampang diakses kapan wae, iso ningkatno mood lan ngilangno bete. Musik sing pas iso nggawe semangatmu bali nek lagi capek atau suntuk. Playlist iki iso dadi teman setiamu kapan wae." 
    },
    { 
        id: 24, 
        title: "Senam ringan", 
        description: "Olahraga cilik nanging penting kanggo gerakke badan ben ora kaku terus.", 
        how: "Gerak-gerak sederhana 5-10 menit, koyok stretching tangan, muter pundak, atau goyang tipis.", 
        benefit: "Awak dadi luwih seger, ora gampang pegel, lan pikiran luwih enteng. Senam cilik iki iso ngilangno stres mergo kelamaan duduk. Nek rutin, badan iso luwih bugar meskipun ora olahraga berat." 
    },
    { 
        id: 25, 
        title: "Ngucap salam esuk-esuk", 
        description: "Awali dina dengan sapaan apik iso gawe suasana omah luwih nyenengke.", 
        how: "Sapa anggota keluarga, ucapke salam, senyum, atau canda tipis sakdurunge mulai aktivitas.", 
        benefit: "Suasana rumah dadi luwih hangat lan akrab mergo awal hari diawali energi positif. Kabeh wong iso ngrasakke perhatian lan rasa dihormati. Iki kegiatan cilik tapi iso nguatno hubungan lan mood sak dina." 
    },
    { 
        id: 26, 
        title: "Ngrampungke tugas rumah cilik", 
        description: "Tugas rumah sing cilik iso dirampungke sekalian ben omah ora berantakan.", 
        how: "Rapikan barang-barang cilik, sapu lantai sak sudut, atau cuci gelas bekas ngopi.", 
        benefit: "Lingkungan resik nggawe awakmu luwih tenang lan ora bingung golek barang. Kerjaan iso luwih fokus mergo ora keganggu amburadul barang. Pikiran luwih adem lan suasana omah berasa nyaman." 
    },
    { 
        id: 27, 
    ...
    { 
        ...
        how: "Coba gambar sederhana, nulis puisi receh, doodle, atau kerajinan DIY sederhana.", 
    ...
    { 
        ...
        how: "Telpon sebentar, kirim WA, atau chatting santai karo kanca sing wis suwe ora kontak.", 
    ...
    { 
        ...
        description: "Nambah ilmu ora harus berat, cukup video ringan tapi manfaat.", 
        how: "Buka YouTube, TikTok edukatif, atau video motivasi minimal 10 menit, nek iso dicatet sek.", 
    ...
    { 
        ...
        description: "Lemari sing rapi iso nggawe kamar ora semrawut lan enak dipandang, ra nggawe pikiran ruwet.", 
        how: "Susun baju sing wis acak-acakan, pisahno sing bersih lan sing kudu dicuci, trus rapikno barang-barang kecil nang pojokan.", 
    ...
    { 
        ...
        description: "Belajar masak ora kudu langsung angel, bisa mulai saka resep simpel sing enak lan gampang ditiru.", 
        how: "Tulis resep anyar nang buku catetan utawa HP, lengkap karo bahan lan langkah-langkah sederhanane.", 
        benefit: "Sampean iso masak kapan wae tanpa bingung nyari resep, tinggal lihat catetanmu. Rasa puas muncul mergo iso masak karya sendiri. Nek rutin, iso jadi koleksi resep pribadi sing bangga dibagi menyang wong liya." 
    },
    { 
        id: 33, 
        title: "Maca berita positif", 
        description: "Berita sing apik iso nggawe pikiran adem, ora stres karo berita sing mbake semangat mudhun.", 
        how: "Pilih berita inspiratif, kisah sukses, atau kabar positif saka internet utawa TV, cukup 5-10 menit wae.", 
    ...
    { 
        ...
        description: "Wektu bareng keluarga meski sebentar iso nggawe hubungan tambah hangat lan akrab.", 
        how: "Keluar rumah bareng keluarga minimal 15-20 menit, entah mlaku-mlaku, tuku jajanan, atau ngobrol nang teras.", 
    ...
    { 
        ...
        benefit: "Sampean iso merasa lebih percaya diri mergo penampilan online rapi lan sesuai dirimu. Kadhang update profil iso ngasih semangat anyar, kaya refresh hidup digitalmu. Wong liya yo iso ngerti versi terbaikmu." 
    },
    { 
        id: 36, 
        ...
        benefit: "Belajar dadi luwih fokus mergo musik iso nolak bosan lan gangguan pikiran. Sampean iso nyerap ilmu luwih cepet lan tenang. Nek dilakoni rutin, kualitas belajarmu iso meningkat lumayan akeh." 
    },
    { 
        id: 37, 
        ...
        benefit: "Sampean iso melu ngirit listrik lan bantu lingkungan tetep lestari. Kebiasaan cilik iki iso dadi langkah awal peduli bumi. Nek diterusno, iso ngirit biaya listrik lan nggawe lingkungan luwih nyaman." 
    },
    { 
        id: 38, 
        title: "Ngasah kemampuan bahasa", 
        description: "Belajar bahasa anyar iso dadi kegiatan menarik lan bermanfaat jangka panjang.", 
        how: "Baca artikel bahasa asing 10 menit, catet kosa kata anyar, utawa cobak ngomong siji-dua kalimat.", 
        benefit: "Kosa kata nambah, otak iso mikir luwih luwes lan terbuka karo budaya liane. Sampean jadi ora kagok nek ketemu istilah asing. Nek rutin, iso ningkatno skill bahasa tanpa kerasa." 
    },
    { 
        id: 39, 
        ...
        benefit: "Belanja dadi lebih tertata, ora kesuwen nang toko, lan ora kebuang-buang duit. Sampean iso fokus tuku barang sing bener-bener perlu. Ati dadi lega mergo ora menyesal belanja sing ora penting." 
    },
    { 
        id: 40, 
        title: "Ngatur email", 
        description: "Email sing kebak spam iso nggawe ruwet lan ngganggu fokus kerja utawa sekolah.", 
    ...
    { 
        ...
        how: "Catet acara penting minggu iki nang kalender HP, buku agenda, utawa notes. Yen perlu, tambahi alarm ben ora kelupaan.", 
        benefit: "Sampean ora gampang kelupaan kegiatan penting lan dadi luwih tertata. Pikiran luwih tenang mergo kabeh wis dijadwalno dengan jelas. Nek sering, hidupmu iso jadi lebih terencana dan produktif.", 
    },
    { 
        id: 43, 
        title: "Nyetel alarm cilik kanggo istirahat", 
        description: "Awakmu kadang kerja terus nganti lali ngaso. Alarm iki ngelingke ben awak iso istirahat sak bentar ben ora kecapekan.", 
    ...
    { 
        ...
        benefit: "Doodle bantu ngilangno rasa bosan, stres, lan mumet kepala. Sampean iso ngrasakke fun cilik sing marai ati seneng. Kreativitasmu yo iso berkembang tanpa tekanan.", 
    },
    { 
        id: 45, 
        ...
        how: "Tambah lagu-lagu upbeat atau semangat durasi 10-15 menit nang playlist olahraga. Pilih lagu sing nggawe awakmu pingin goyang utawa gerak.", 
        benefit: "Olahraga dadi lebih semangat lan ora kerasa capek mergo musik sing nyemangati. Mood iso langsung naik meskipun kegiatan fisik sederhana. Nek sering, awak iso luwih sehat lan happy.", 
    },
    { 
        id: 46, 
        title: "Ngucap makasih marang wong liya", 
        description: "Kegiatan sederhana sing iso nambah vibes positif lan nggawe wong liya ngrasakke dihargai.", 
        how: "Ucapan makasih nganggo lisan, chat WA, utawa tulisan cilik. Yen perlu, tambahi emotikon ben luwih hangat lan tulus.", 
        benefit: "Ngucap makasih iso nyebarke energi positif neng sekitar lan nggawe suasana luwih hangat. Wong sing nampa ucapane iso ngrasakke dihargai lan diapresiasi. Sampean yo dadi pribadi sing lebih ramah lan rendah hati.", 
    },
    { 
        id: 47, 
        title: "Nggawe plan sederhana esuk", 
        description: "Supaya hari luwih fokus lan ora bingung kudu ngapa dhisik. Rencana cilik iso dadi pandhuan sak dina.", 
        how: "Tulis 3 target penting esuk iki nang kertas utawa HP. Pilih sing sederhana tapi iso dilakoni seharian.", 
        benefit: "Sampean dadi luwih fokus lan ora bingung mikir kudu ngapa dhisik. Rasa produktif meningkat nek iso nuruti rencana sing wis ditulis. Ati dadi seneng mergo tugasmu kelakon sesuai target.", 
    },
    { 
        id: 48, 
        title: "Nulis doa cendhak", 
        description: "Doa sederhana kanggo ngelingke rasa syukur, ketenangan, lan pengharapan anyar kanggo dina iki.", 
        how: "Doa 2-3 kalimat nang hati utawa tulisan. Ora usah panjang, sing penting tulus lan ikhlas saka atimu.", 
        benefit: "Doa cilik iso menenangkan hati lan menehi rasa syukur marang urip sing wis dilakoni. Sampean iso merasa lebih adem lan ora gampang stres. Nek sering, hati iso lebih kuat dan sabar menghadapi hari-hari.", 
    },
    { 
        id: 49, 
        title: "Ngajak tetangga ngobrol santai", 
        description: "Menjaga hubungan apik karo tangga supaya ora sungkanan lan tetep rukun.", 
        how: "Sapa karo senyum, terus ngobrol cendhak soal kabar, kegiatan, utawa cerita cilik santai.", 
        benefit: "Hubungan karo tetangga dadi luwih akrab lan ora sungkanan. Sampean iso ngrasakke rasa nyaman tinggal nang lingkungan sing rukun. Yen akrab, urusan tetangga iso luwih gampang dibantu sak wayah-wayah.", 
    },
    { 
        id: 50, 
        title: "Ngatur meja kerja", 
        description: "Ben kerjo luwih nyaman, meja kudu rapi ben ora amburadul lan pikiran ora sumpek.", 
        how: "Rapikan buku, laptop, alat tulis, lan barang-barang sing ora penting. Yen perlu, tambahi dekor cilik ben luwih asik.", 
        benefit: "Meja kerja sing rapi iso ningkatno fokus lan semangat kerjamu. Pikiran ora mumet mergo lingkungan tertata lan bersih. Nek terus dijaga, suasana kerja dadi lebih nyaman lan produktif.", 
    }
];
